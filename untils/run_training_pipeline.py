...
def step_train_cwe(force: bool, bert_model: str, epochs: int, batch: int) -> bool:
    """Step 3.5: Fine-tune SecBERT for CWE classification (Track 3)."""
...
def print_summary(results: dict[str, bool]) -> None:
    ...
    labels = {
        ...
        "cwe":       "Fine-tuned SecBERT (CWE — Track 3)",
...
def main():
    ...
    parser.add_argument(
        ...
        help="Skip CWE classifier fine-tuning (Track 3)",
    )
    parser.add_argument(
    ...
    # ── Step 3.5: CWE classifier (Track 3) ──
